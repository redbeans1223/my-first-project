// C:\Users\NoriakiM\projects\roulette-frontend\src\RouletteScreen.js
...
const RouletteScreen = () => {
    ...
    const [segments, setSegments] = useState(
        ...
        (location.state?.type === 'number' ? 
            Array.from({ length: location.state?.end - location.state?.start + 1 }, 
                (_, i) => String(i + location.state?.start)) : 
            ['1', '2', '3', '4', '5', '6'])
    );
